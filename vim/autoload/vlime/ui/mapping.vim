if !exists('g:vlime_default_mappings')
    ...
    let g:vlime_default_mappings = {
                \ 'lisp': [
                    ...
                    \
                    \ ['n', '<LocalLeader>xc', ':call VlimeXRefSymbol("CALLS",        vlime#ui#CurAtom(), win_getid())<cr>'],
                    \ ['n', '<LocalLeader>xC', ':call VlimeXRefSymbol("CALLS-WHO",    vlime#ui#CurAtom(), win_getid())<cr>'],
                    \ ['n', '<LocalLeader>xr', ':call VlimeXRefSymbol("REFERENCES",   vlime#ui#CurAtom(), win_getid())<cr>'],
                    \ ['n', '<LocalLeader>xb', ':call VlimeXRefSymbol("BINDS",        vlime#ui#CurAtom(), win_getid())<cr>'],
                    \ ['n', '<LocalLeader>xs', ':call VlimeXRefSymbol("SETS",         vlime#ui#CurAtom(), win_getid())<cr>'],
                    \ ['n', '<LocalLeader>xe', ':call VlimeXRefSymbol("MACROEXPANDS", vlime#ui#CurAtom(), win_getid())<cr>'],
                    \ ['n', '<LocalLeader>xm', ':call VlimeXRefSymbol("SPECIALIZES",  vlime#ui#CurAtom(), win_getid())<cr>'],
                    \ ['n', '<LocalLeader>xd', ':call VlimeFindDefinition(vlime#ui#CurAtom(), win_getid())<cr>'],
                    \
